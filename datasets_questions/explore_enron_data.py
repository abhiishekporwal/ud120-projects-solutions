...
print("Email Messages do we have from Wesley Colwell: ", enron_data['COLWELL WESLEY']['from_this_person_to_poi'])
...
print('Quantified salary: ', salaries_not_nan)
print('Availabel Emails: ', known_emails)
print('Number Percentage people “NaN” for their total payments: ',total_payments_not_nan, total_payments_not_nan*100/len(enron_data))
print('Number and Percentage Pois “NaN” for their total payments: ',total_payments_not_nan_poi, total_payments_not_nan_poi*100/count)